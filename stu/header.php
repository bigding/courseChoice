...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
    <ul>
        ...
        <li><a href="chooseCourseBySearch.php"><i class="icon icon-signal"></i> <span>选择课程</span></a>
        </li>
<!--        <li><a href="judgeTeacher.html"><i class="icon icon-inbox"></i> <span>评价</span></a></li>-->
        <li><a href="studentCourseTable.php"><i class="icon icon-th"></i> <span>课程表</span></a></li>
    </ul>
</div>